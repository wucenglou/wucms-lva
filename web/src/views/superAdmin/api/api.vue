    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        ...
        <el-popover v-model:visible="deleteVisible" placement="top" width="160">
          ...
          <template #reference>
            <el-button icon="delete" :disabled="!apis.length" style="margin-left: 10px;">删除</el-button>
          </template>
        </el-popover>
      </div>
      <el-table :data="tableData" @sort-change="sortChange" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="left" label="请求" min-width="150" prop="methods" sortable="custom">
        ...
        <el-table-column align="left" fixed="right" label="操作" width="200">
          <template #default="scope">
            <el-button icon="edit" size="small" type="primary" @click="editApi(scope.row)">编辑</el-button>
            <el-button icon="delete" size="small" type="primary" @click="deleteApiFun(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
