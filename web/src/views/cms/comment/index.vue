  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column label="分类" min-width="100" prop="catName" />
        <el-table-column label="原文标题" min-width="100" prop="title" />
        <el-table-column label="评论人" min-width="100" prop="authorName" />
        <el-table-column label="评论内容" min-width="100" show-overflow-tooltip prop="content" />
...
import { getPosts, deletePost, optionsPost, getComments } from '@/api/post'
...
const getTableData = async () => {
  ...
  const tablePost = await getComments({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (tablePost.code === 0) {
...
const handleSelectionChange = (val) => {
  ...
  val.forEach(item => {
    ...
    deleteInfo.value.modeId = searchInfo.value.modeId
  });
}
